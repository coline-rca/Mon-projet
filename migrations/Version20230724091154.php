 ...
 */
final class Version20230724091154 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_has_product (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, orderr_id INT NOT NULL, quantity INT NOT NULL, INDEX IDX_AF0913F07742FDB3 (orderr_id), INDEX IDX_AF0913F04584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
